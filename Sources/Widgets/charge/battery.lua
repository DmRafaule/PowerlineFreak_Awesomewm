...
local WIDGET_DIR = HOME .. '/.config/awesome/Sources/Widgets/charge'
...
local function worker(user_args)
    ...
    local path_to_icons = args.path_to_icons or gfs.get_configuration_dir() "/home/dimond/.config/awesome/Pictures/Icons/status/"
